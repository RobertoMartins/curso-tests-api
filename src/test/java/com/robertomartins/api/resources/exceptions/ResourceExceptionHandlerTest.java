package com.robertomartins.api.resources.exceptions;
...
class ResourceExceptionHandlerTest {
    ...
    @Test
    void whenObjectNotFoundReturnAResponseEntity() {
    ...
    void whenDataIntegrityViolationExceptionThenReturnAResponseEntity() {
        ResponseEntity<StandardError> response = exceptionHandler
                .dataIntegrityViolationException(new DataIntegratyViolationException(EMAIL_JA_CADASTRADO), new MockHttpServletRequest());
        assertNotNull(response);
        assertNotNull(response.getBody());
