...
class UserServiceImplTest {
    ...
    @Test
    void whenUpdateAndReturnSuccess() {
        when(repository.save(any())).thenReturn(user);

        User result = service.update(userDTO);
    ...
    @Test
    void whenUpdateAndReturnAnDataIntegrityViolationException() {
        when(repository.findByEmail(anyString())).thenReturn(optionalUser);
    ...
    @Test
    void whenDeleteAndReturnSuccess() {
